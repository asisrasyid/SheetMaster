        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return (
              '<div>' +
              '<div class="dropdown">' +
              '<a href="javascript:;" class="btn btn-sm btn-icon btn-text-secondary dropdown-toggle hide-arrow text-body rounded-pill waves-effect" data-bs-toggle="dropdown"><i class="ri-more-2-line ri-22px"></i></a>' +
